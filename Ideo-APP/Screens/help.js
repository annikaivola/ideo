            ...
            <ScrollView style={{ backgroundColor: "#1ac5c3" }}>
                <View style={styles.container}>
                    <View>
                        ...
                        <Text style={styles.helpSubheading}>Ideo is a simple tool to help you brainstorm ideas within a group!</Text>
                        ...
                        <Text style={styles.helpPhaseText}>Collect as much ideas as you can!
                        ...
                        <Text style={styles.helpPhaseText}>After collecting as many ideas as possible, it's time to evaluate the ideas and choose the best ones.
                            ...
                            This way you can collect many points of view on each idea conveniently. The ideas with the highest total of arguments for the idea will rise to the top of your Ideafeed - how convenient!
            </Text>
                        <View style={{ height: 20 }} />
